...
def create_rally_defect(rally_project, problem_sys_id, rally_defect_title, rally_defect_description, rally_defect_state, rally_defect_sstate, defect_correlation_id):
    ...
    # Updating the SNOW description with the defect number and correlation_id value
...
# Mapping function
def mapping_snow_problem_to_rally_defect_first_time(snow_assignmentgrp,snow_problem_sh_desc,snow_problem_desc,snow_problem_number,
...
def mapping_snow_problem_to_rally_defect_next_time(snow_assignmentgrp,snow_problem_sh_desc,snow_problem_desc,snow_problem_number,
                                         snow_problem_state,snow_problem_priority,snow_problem_impact):
